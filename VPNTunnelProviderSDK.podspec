Pod::Spec.new do |spec|
  ...
  spec.osx.user_target_xcconfig = { 'EXCLUDED_ARCHS' => 'arm64', 'OTHER_LDFLAGS' => '-lObjC', 'SWIFT_INCLUDE_PATHS' => '${PODS_ROOT}/VPNTunnelProviderSDK/VPNTunnelProviderSDK.xcframework/AdditionalModules/macos/** ${PODS_ROOT}/VPNTunnelProviderSDK/VPNTunnelProviderSDK.xcframework/AdditionalModules/objc/**' }
