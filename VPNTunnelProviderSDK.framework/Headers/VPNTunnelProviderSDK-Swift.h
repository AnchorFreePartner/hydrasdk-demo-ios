...
SWIFT_CLASS("_TtC20VPNTunnelProviderSDK17AFVirtualLocation")
...
@property (nonatomic, readonly, copy) NSString * _Nullable connectionAttemptID;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
- (void)generateConnectionAttemptWithLocationCode:(NSString * _Nullable)locationCode triggeredByUser:(BOOL)triggeredByUser;
- (void)setConnectionInfoWithServerIP:(NSString * _Nullable)serverIP sessionID:(NSString * _Nullable)sessionID;
- (void)setConnectionError:(NSError * _Nullable)error;
- (void)updateConnectedTimestamp;
...
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
- (void)setupWithSDKVersion:(NSString * _Nullable)versionString hydraVersion:(NSString * _Nullable)hydraVersion;
