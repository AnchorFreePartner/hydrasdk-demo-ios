...
FOUNDATION_EXPORT double VPNSDK_NE_OSXVersionNumber;

//! Project version string for VPNSDK_NE.
FOUNDATION_EXPORT const unsigned char VPNSDK_NE_OSXVersionString[];

static NSString *const _Nonnull AFTunnelProviderVersion = @"3.1.8";
