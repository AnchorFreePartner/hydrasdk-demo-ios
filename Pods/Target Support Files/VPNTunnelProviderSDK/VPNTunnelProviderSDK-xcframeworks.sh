...
install_xcframework "${PODS_ROOT}/VPNTunnelProviderSDK/VPNTunnelProviderSDK.xcframework" "VPNTunnelProviderSDK" "framework" "ios-arm64" "ios-arm64_x86_64-simulator"
