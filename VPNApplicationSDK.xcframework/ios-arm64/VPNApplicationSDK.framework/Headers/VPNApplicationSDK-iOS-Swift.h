...
typedef SWIFT_ENUM(NSInteger, AFTransportError, open) {
  AFTransportErrorStatusChangedToInvalid = 1,
  AFTransportErrorCanceled = 2,
  AFTransportErrorUnknown = 3,
  AFTransportErrorConnectFailed = 4,
  AFTransportErrorStartInProgress = 5,
  AFTransportErrorStopInProgress = 6,
  AFTransportErrorTimeout = 7,
  AFTransportErrorWrapped = 8,
  AFTransportErrorTunnelError = 9,
  AFTransportErrorRateLimit = 10,
  AFTransportErrorNotConnected = 11,
  AFTransportErrorNotReady = 12,
  AFTransportErrorUnableToEncodeMessage = 13,
  AFTransportErrorEmptyData = 14,
  AFTransportErrorUnableToDecodeResponse = 15,
  AFTransportErrorAppMessageFailureResult = 16,
};
