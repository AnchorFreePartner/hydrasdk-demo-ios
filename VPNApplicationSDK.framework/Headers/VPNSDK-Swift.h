...
#import <VPNApplicationSDK/VPNApplicationSDK.h>
...
typedef SWIFT_ENUM(NSInteger, AFAPIError, closed) {
...
typedef SWIFT_ENUM(NSInteger, AFAuthMethodType, closed) {
...
enum CategoryType : NSInteger;

SWIFT_CLASS("_TtC17VPNApplicationSDK20AFFireshieldCategory")
@interface AFFireshieldCategory : NSObject
+ (AFFireshieldCategory * _Nonnull)blockWithCategory:(enum CategoryType)category SWIFT_WARN_UNUSED_RESULT;
+ (AFFireshieldCategory * _Nonnull)proxyWithCategory:(enum CategoryType)category SWIFT_WARN_UNUSED_RESULT;
+ (AFFireshieldCategory * _Nonnull)bypassWithCategory:(enum CategoryType)category SWIFT_WARN_UNUSED_RESULT;
+ (AFFireshieldCategory * _Nonnull)alertWithCategory:(enum CategoryType)category SWIFT_WARN_UNUSED_RESULT;
+ (NSString * _Nonnull)categoryNameFrom:(enum CategoryType)category SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

typedef SWIFT_ENUM(NSInteger, CategoryType, closed) {
  CategoryTypeSafe = 0,
  CategoryTypeUnsafe = 1,
  CategoryTypeMalware = 2,
  CategoryTypeUnsafeCustom = 3,
};
...
+ (AFFireshieldRule * _Nullable)ruleWithFileName:(NSString * _Nonnull)fileName category:(enum CategoryType)category error:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@property (nonatomic, readonly) BOOL isOptimalLocationEnabled;
...
typedef SWIFT_ENUM(NSInteger, FireshieldMode, closed) {
...
typedef SWIFT_ENUM(NSInteger, FireshieldService, closed) {
...
- (void)startWithLocation:(AFVirtualLocation * _Nonnull)location completion:(void (^ _Nonnull)(NSError * _Nullable))completion;
...
typedef SWIFT_ENUM(NSInteger, VPNState, closed) {
  VPNStateInvalid = 0,
...
SWIFT_CLASS("_TtC17VPNApplicationSDK10VPNTracker")
...
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
- (void)setFlushIntervalWithInterval:(NSUInteger)interval;
- (void)reportConnectionStart;
- (void)reportConnectionEnd;
- (void)flush;
@end
