...
@property (nonatomic, readonly, copy) NSString * _Nonnull carrierID;
@property (nonatomic, readonly, copy) NSString * _Nonnull hostURL;
...
- (void)purchaseWithToken:(NSString * _Nullable)token completion:(void (^ _Nonnull)(NSError * _Nullable, NSDictionary<NSString *, id> * _Nullable))completion;
